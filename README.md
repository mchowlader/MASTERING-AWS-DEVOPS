...
#### 📌 Tasks  
📌 **Please note that I am writing the documentation here using manual commands. If you want you can chekc my manual script [here](Assignment%201/Automated_Script.sh).**
